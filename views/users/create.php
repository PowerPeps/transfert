<div class="max-w-2xl mx-auto bg-white p-8 border-2 border-soviet-gray soviet-container">
    <h1 class="text-2xl font-bold mb-2 uppercase tracking-wider">Créer un Nouvel Utilisateur</h1>
    <p class="text-gray-600 mb-6">Créez un nouveau compte utilisateur et définissez ses appartenances aux groupes.</p>
    ...
    <form action="<?= BASE_URL ?>/users/create" method="post" class="space-y-6">
        <div>
            ...
            <div class="space-y-4 border-2 border-soviet-gray p-4">
                <div>
                    ...
                    <input type="text" id="username" name="username" class="w-full px-3 py-2 border-2 border-soviet-gray" required>
                </div>
                
                <div>
                    <label for="password" class="block text-soviet-gray font-bold mb-2 uppercase">Mot de passe <span class="text-soviet-red">*</span></label>
                    <input type="password" id="password" name="password" class="w-full px-3 py-2 border-2 border-soviet-gray" required>
                </div>
                    ...
                    <div class="border-t border-soviet-gray pt-2">
                        <?php foreach ($groups as $group): ?>
                            <div class="flex items-center mb-2 p-2">
                                <input type="checkbox" id="group_<?= $group['id'] ?>" name="groups[]" value="<?= $group['id'] ?>" class="mr-2 group-checkbox">
        ...
        <div class="bg-soviet-lightgray p-4 border-l-4 border-soviet-red mt-4">
            <h3 class="font-bold uppercase mb-2">Étapes suivantes</h3>
            <p>Après avoir créé l'utilisateur, vous pourrez:</p>
            <ul class="list-disc ml-5 mt-2">
                <li>Partager des fichiers avec cet utilisateur</li>
                <li>Définir des permissions spécifiques</li>
                <li>Modifier son appartenance aux groupes</li>
            </ul>
        </div>
